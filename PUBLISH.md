...
3. Click **Submit**, paste: `https://github.com/Multek-Company/laravel-onesignal`
...
Check [packagist.org/packages/multek/laravel-onesignal](https://packagist.org/packages/multek/laravel-onesignal) — the new version should appear instantly (webhook is configured).
...
# Specific version
composer require multek/laravel-onesignal:^1.0
